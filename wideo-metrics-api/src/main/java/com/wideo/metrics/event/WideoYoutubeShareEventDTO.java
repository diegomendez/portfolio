...
public class WideoYoutubeShareEventDTO extends GenericEventDTO {
    ...
    public WideoYoutubeShareEventDTO(String wideoID, Long userID, Map<String, Object> props, Map<String, Object> userAgentProperties) {
        super(EventNamespaceTypesEnum.player.getName(),WideoEventTypesEnum.YOUTUBE_SHARE.getName(),props,userAgentProperties);
