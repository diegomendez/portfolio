...
public class ViewsByWideoByDayByBrowserTask_2 extends Task_2 {

    public ViewsByWideoByDayByBrowserTask_2(DBCollection dbCollection, StatsFilterProcessorBOImpl statsFilterProcessorBOImpl) {
    ...
    public TaskResponse process(ProcessingKey processingKey,
        ...
        try {
            ...
            sbMap.append("emit(key, { wideo_id: this.wideo_id, date: date_utc, action: this.action, browser: this.browser, count: 1});");
            sbMap.append("}");
            ...
            String reduce = "function (key, values) { "
                    ...
                    + " } "
                    + " return { wideo_id: values[i].wideo_id, date: values[i].date, action: values[i].action, browser: values[i].browser, count:total } }";
            ...
            try {
                ...
                filterStatsByProperty(out.results(), (Date) dateObject.get("$gte"), "browser");
            }
