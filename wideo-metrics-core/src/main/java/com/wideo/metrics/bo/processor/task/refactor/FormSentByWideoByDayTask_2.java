...
public class FormSentByWideoByDayTask_2 extends Task_2 {

    public FormSentByWideoByDayTask_2(DBCollection dbCollection, StatsFilterProcessorBOImpl statsFilterProcessorBOImpl) {
    ...
    public TaskResponse process(ProcessingKey processingKey,
        ...
        try {
            ...
            try {
                ...
                filterInteractionStats(out.results(), (Date) dateObject.get("$gte"));
            }
