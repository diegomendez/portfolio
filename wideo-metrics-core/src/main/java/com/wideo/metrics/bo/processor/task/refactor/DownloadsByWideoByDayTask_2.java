...
public class DownloadsByWideoByDayTask_2 extends Task_2 {
    
    public DownloadsByWideoByDayTask_2(DBCollection dbCollection, StatsFilterProcessorBOImpl statsFilterProcessorBOImpl) {
    ...
    public TaskResponse process(ProcessingKey processingKey,
        ...
        try {
            ...
            sbMapKey.append("\"" + WideoEventTypesEnum.WIDEO_DOWNLOAD.getName()
                    + "\"");
            sbMapKey.append(",");
            ...
            JSONObject errorJsonData = parseErrorJsonResponse(
                    processingKey.getName(), mapReduceQuery.get("date"), e.getMessage());
