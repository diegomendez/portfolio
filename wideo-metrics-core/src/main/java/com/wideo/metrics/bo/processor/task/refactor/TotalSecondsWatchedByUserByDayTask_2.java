...
public class TotalSecondsWatchedByUserByDayTask_2 extends Task_2 {

    public TotalSecondsWatchedByUserByDayTask_2(DBCollection dbCollection, StatsFilterProcessorBOImpl statsFilterProcessorBOImpl) {
    ...
    public TaskResponse process(ProcessingKey processingKey,
        ...
        try {
            ...
            sbMap.append("emit(key, { user_id: this.user_id, date: date_utc, action: \"SECONDS_WATCHED\", count: 1 });");
            sbMap.append("}");
