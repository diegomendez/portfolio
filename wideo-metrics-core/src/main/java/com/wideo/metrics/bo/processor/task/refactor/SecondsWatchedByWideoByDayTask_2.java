...
public class SecondsWatchedByWideoByDayTask_2 extends Task_2 {

    public SecondsWatchedByWideoByDayTask_2(DBCollection dbCollection, StatsFilterProcessorBOImpl statsFilterProcessorBOImpl) {
    ...
    public TaskResponse process(ProcessingKey processingKey,
        ...
        try {
            ...
            sbMap.append("emit(key, { wideo_id: this.wideo_id, date: date_utc, action: \"SECONDS_WATCHED\", count: 1});");
            sbMap.append("}");
